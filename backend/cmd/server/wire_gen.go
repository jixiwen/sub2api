...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	imageStudioJobService := service.ProvideImageStudioJobService(imageStudioJobRepository, settingService, imageStudioInputStorage, openAIGatewayService, apiKeyService, billingCacheService, subscriptionService)
