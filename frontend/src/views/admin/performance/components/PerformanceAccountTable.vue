      ...
      <div v-else class="mt-4 overflow-x-auto">
        <table class="w-full min-w-[980px] border-collapse text-left text-sm">
          <thead class="border-y border-gray-200 text-xs text-gray-500 dark:border-dark-700 dark:text-gray-400">
            <tr>
              <th class="px-3 py-2 font-medium" :aria-sort="ariaSort('account_id')"><button type="button" class="inline-flex min-h-11 items-center gap-1 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-dark-800" @click="emit('sort', 'account_id')">账号 <Icon name="sort" size="xs" aria-hidden="true" /></button></th>
              <th class="px-3 py-2 font-medium" :aria-sort="ariaSort('platform')"><button type="button" class="inline-flex min-h-11 items-center gap-1 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-dark-800" @click="emit('sort', 'platform')">平台 <Icon name="sort" size="xs" aria-hidden="true" /></button></th>
              ...
              <th class="px-3 py-2 font-medium" :aria-sort="ariaSort('attempt_count')"><button type="button" class="inline-flex min-h-11 items-center gap-1 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-dark-800" @click="emit('sort', 'attempt_count')">尝试次数 <Icon name="sort" size="xs" aria-hidden="true" /></button></th>
            </tr>
          </thead>
