export default {
  ...
  admin: {
    usageCards: {
      ...
      description:
        'Usage card plans are products users buy from Recharge / Subscription. After payment, users receive a usage card that can be charged in any group up to the available amount.',
      planName: 'Plan Name',
    ...
    redeem: {
      ...
      usageCardHint:
        'Select an existing usage card plan. The expiry below only controls the redeem code itself.',
