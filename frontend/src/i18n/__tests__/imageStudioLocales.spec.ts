...
const requiredKeys = [
  ...
  'imageStudio.addMask',
  'imageStudio.removeMask',
  'imageStudio.remove',
  'imageStudio.referenceLimit',
  'imageStudio.compressionErrors.canvasUnsupported',
  'imageStudio.compressionErrors.decodeFailed',
  'imageStudio.compressionErrors.encodeFailed',
  'imageStudio.compressionErrors.invalidDimensions',
