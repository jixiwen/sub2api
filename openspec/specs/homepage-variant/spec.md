# homepage-variant Specification

## Purpose
Define runtime selection of the public homepage variant through the `HOMEPAGE_VARIANT` container environment variable and expose the normalized value to clients.
